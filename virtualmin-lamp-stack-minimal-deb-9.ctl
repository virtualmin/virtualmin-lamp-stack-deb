...
Recommends: postfix, postfix-pcre, bind9, ibdbd-mysql-perl, quota, spamc, procmail, procmail-wrapper, clamav-base, clamav, iptables, firewalld, mysql-server, mysql-client, mysql-common, proftpd php-mcrypt, php-mbstring, php7.0-mysql, php7.0-mcrypt, php7.0-mbstring, jailkit, fail2ban
