...
Recommends: postfix, postfix-pcre, bind9, libdbd-mysql-perl, quota, spamc, procmail, procmail-wrapper, clamav-base, clamav, iptables, firewalld, mysql-server, mysql-client, mysql-common, proftpd, php-mcrypt, php-mbstring, php7.0-mysql, php7.0-mcrypt, php7.0-mbstring, jailkit, fail2ban
Suggests: postgresql, postgresql-client, libdbd-pg-perl, libpg-perl, clamav-daemon, clamav-freshclam, clamav-docs, clamav-testfiles, libsasl2-2, libsasl2-modules, sasl2-bin, libconfig-inifiles-perl, spamassassin, postgrey, awstats, webalizer, dovecot-common, dovecot-imapd, dovecot-pop3d
