...
Recommends: perl-doc, postfix, postfix-pcre, bind9, libdbd-mysql-perl, libxml-simple-perl, quota, spamc, procmail, procmail-wrapper, clamav-base, clamav, iptables, firewalld, mariadb-server, mariadb-client, mariadb-common, proftpd, php-mcrypt, php-mbstring, jailkit, dovecot-core, dovecot-imapd, dovecot-pop3d, libsasl2-2, libsasl2-modules, sasl2-bin
Suggests: postgresql, postgresql-client, libdbd-pg-perl, libpg-perl, clamav-daemon, clamav-freshclam, clamav-docs, clamav-testfiles, libconfig-inifiles-perl, spamassassin, postgrey, awstats, fail2ban, milter-greylist, unrar, p7zip, xz-utils, certbot
