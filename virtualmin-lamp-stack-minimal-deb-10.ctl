...
Recommends: postfix, postfix-pcre, bind9, libdbd-mysql-perl, quota, spamc, procmail, procmail-wrapper, clamav-base, clamav, iptables, firewalld, mariadb-server, mariadb-client, mariadb-common, proftpd, php-mcrypt, php-mbstring, jailkit, dovecot-core, dovecot-imapd, dovecot-pop3d, libsasl2-2, libsasl2-modules, sasl2-bin
