...
Recommends: libdbd-mysql-perl, iptables, firewalld, clamav, clamav-base, spamc, procmail, procmail-wrapper, mysql-server, mysql-client, mysql-common, proftpd, php5-mbstring, php5-mcrypt, jailkit, php7.0-mysql, php7.0-mcrypt, php7.0-mbstring, php7.1-mysql, php7.1-mcrypt, php7.1-mbstring, dovecot-core, dovecot-imapd, dovecot-pop3d, libsasl2-2, libsasl2-modules, sasl2-bin
