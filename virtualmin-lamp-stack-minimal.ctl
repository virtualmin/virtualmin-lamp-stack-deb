...
Recommends: libdbd-mysql-perl, iptables, firewalld, clamav, clamav-base, mysql-server, mysql-client, mysql-common, proftpd, php5-mbstring, php5-mcrypt, jailkit, fail2ban
