...
Recommends: ruby, irb, rdoc, ri, bind9, spamassassin, spamc, procmail, procmail-wrapper, libdbd-mysql-perl, quota, iptables, firewalld, mysql-server, mysql-client, mysql-common, awstats, dovecot-core, dovecot-imapd, dovecot-pop3d, proftpd, clamav-base, clamav-daemon, clamav, clamav-freshclam, clamav-docs, clamav-testfiles, libsasl2-2, libsasl2-modules, sasl2-bin, php5-mysql, php5-mbstring, php5-mcrypt, jailkit, procmail-wrapper, fail2ban, postgrey, libconfig-inifiles-perl, php7.0-mysql, php7.0-mcrypt, php7.0-mbstring, php7.1-mysql, php7.1-mcrypt, php7.1-mbstring, milter-greylist, unrar, p7zip, xz-utils
